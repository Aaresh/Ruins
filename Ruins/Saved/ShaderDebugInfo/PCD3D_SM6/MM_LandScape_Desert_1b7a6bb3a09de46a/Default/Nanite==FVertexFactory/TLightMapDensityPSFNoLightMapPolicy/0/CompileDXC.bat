...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T ps_6_6 -E MainPixelShader -Fc LightMapDensityShader.d3dasm -Fo LightMapDensityShader.dxil LightMapDensityShader.usf
:END
PAUSE
