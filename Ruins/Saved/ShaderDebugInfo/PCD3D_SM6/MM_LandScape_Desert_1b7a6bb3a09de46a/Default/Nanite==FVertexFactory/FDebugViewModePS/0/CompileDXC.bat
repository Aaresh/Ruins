...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T ps_6_6 -E Main -Fc DebugViewModePixelShader.d3dasm -Fo DebugViewModePixelShader.dxil DebugViewModePixelShader.usf
:END
PAUSE
